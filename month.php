...
$sql ="select * from customer_info where take_car like '%".$_POST['month']."%'";
...
.blue:hover {
	...
	<div id="main">
		<h1>關聯搜尋客戶清單</h1>
	<div class="jumbotron">
		<h1>『領牌月份』<font size="5">相關結果</font></h1>
		<p><font size="1">下方為領牌月份的搜尋結果，僅列出簡單資訊，但可點選各顧客『詳細』按鈕瀏覽詳細資訊內容</font></p>
		<p><font size="5">搜尋關鍵字為：<?php echo "$month"; ?></font></p>
	</div>
			<?php
