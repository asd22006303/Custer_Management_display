...
$NOW_MONTH = trim(shell_exec("date '+%B'"));
if($NOW_MONTH=='January') $NOW_MONTH='01';
if($NOW_MONTH=='February') $NOW_MONTH='02';
if($NOW_MONTH=='March') $NOW_MONTH='03';
if($NOW_MONTH=='April') $NOW_MONTH='04';
if($NOW_MONTH=='May') $NOW_MONTH='05';
if($NOW_MONTH=='June') $NOW_MONTH='06';
if($NOW_MONTH=='July') $NOW_MONTH='07';
if($NOW_MONTH=='August') $NOW_MONTH='08';
if($NOW_MONTH=='September') $NOW_MONTH='09';
if($NOW_MONTH=='October') $NOW_MONTH='10';
if($NOW_MONTH=='November') $NOW_MONTH='11';
if($NOW_MONTH=='December') $NOW_MONTH='12';

$con = mysqli_connect("localhost",$db_user,$db_passwd);
mysqli_query($con, "SET NAMES 'UTF8'");
mysqli_select_db($con,$db_name);
$sql ="select * from customer_info where age_month=".$NOW_MONTH;
...
function Edit_info($row){
	...
	echo "<h3>使用者：$search_month </h3>";
	echo "<p>顧客姓名：$name </p>";
	echo "<p>行動電話：$cellphone </p>";
	echo "<p>出生年齡：$age$age_month$age_day </p>";
...
.blue:hover {
	...
	<div class="jumbotron">
		<h1>本月份生日客戶</h1>
		<p><font size="1">下方為本月份生日客戶的搜尋結果，僅列出簡單資訊，但可點選各顧客『詳細』按鈕瀏覽詳細資訊內容</font></p>
		<p><font size="5">搜尋月份為：<?php echo "$NOW_MONTH"; ?></font></p>
	</div>
			<?php
